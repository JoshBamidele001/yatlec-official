...
export default function TheYouthChurch() {
  return (
    <>
        ...
        <div className='max-w-7xl mt-10 md:mt-10 md:mx-10 mx-auto grid grid-cols-1 md:grid-cols-[30%_70%] lg:grid-cols-2 gap-10 lg:mt-10'>

              <div className='flex items-center justify-center'>

                <div className='h-[250px] w-[250px] md:h-[500px] md:w-[200px]  lg:h-[600px] lg:w-[600px] rounded-3xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110' 
...
<div className='max-w-5xl mx-auto grid grid-cols-1 gap-5 md:gap-0 md:grid-cols-3 lg:grid-cols-4'>
  ...
  <div className='flex items-center justify-center flex-col'>
      ...
      <small>Prayer Coordinator</small>
...
<p  className=' text-2xl md:text-2xl lg:text-3xl font-semibold text-center text-orange-700 md:my-5 lg:my-10  transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110' >UPCOMING EVENTS</p>

      <ol className='max-w-5xl md:mx-auto text-2xl mx-10 '>
